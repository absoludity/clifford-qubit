...
mod matrix_operations {
    //! Quantum gate matrices extracted from QIR matrix_testing module
    //! https://github.com/qir-alliance/qir-runner/blob/main/sparsesim/src/matrix_testing.rs
...
pub mod test_helpers {
    //! Helper functions for testing quantum gates using matrix operations
    ...
    pub fn assert_matrix_result<F>(
        ...
        F: FnOnce() -> matrix_operations::QubitMatrix,
    {
